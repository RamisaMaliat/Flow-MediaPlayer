...
/**
 * This is controller class for PlayAudioPlaylist.fxml
 */
public class PlayAudioPlaylistController implements Initializable {
    List<String> list;
    ...
    /**
     * This function initializes the controller class of PlayAudioPlaylist.fxml.
    ...
    public void initialize(URL url, ResourceBundle rb) {
        title.setText("Currently Playling : "+ViewAudioPlaylistController.playlistname);
        ...
        String p = ViewAudioPlaylistController.playlistname;
    ...
    /**
     * This function plays the previous file in the playlist
     * @param event
     */
    ...
    /**
     * This function plays the initial audio file
     */
    public void InitialPlayAudio() {
        int idx = listView. getSelectionModel(). getSelectedIndex();
        try{
            if(idx == -1) idx = 0;
            listView.getSelectionModel().select(idx);

...
/**
 * This is controller class for ViewVideoPlaylists.fxml
 */
public class ViewVideoPlaylistController implements Initializable {
    ...
    /**
     * This function initializes the controller class of ViewVideoPlaylists.fxml.
     * It connects with the database and fetches the video playlists
     * @param url
     * @param rb
     */
    @Override
    ...
    public void playPlaylist(ActionEvent event) throws IOException{
        ...
        if(idx!=-1){
            ...
            HomePage.setTitle("");
            Parent root = FXMLLoader.load(getClass().getResource("PlayVideoPlaylist.fxml"));
